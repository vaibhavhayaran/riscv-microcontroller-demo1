...
HD_PWD='/home/animandal/vivado_projects/ov2640_nexys/ov2640_nexys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source camera_top.tcl -notrace
