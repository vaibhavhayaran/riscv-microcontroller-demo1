...
HD_PWD='/home/animandal/vivado_projects/ov2640_nexys/ov2640_nexys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_top.tcl
